...
具体来源、版本及版权许可见[第三方代码声明](https://github.com/xiyunmn/CWMHook/blob/main/app/src/main/resources/licenses/glass-notices.txt)。

## 开源许可

Copyright (C) 2026 xiyunmn

本项目依据 [GNU General Public License v3.0](https://github.com/xiyunmn/CWMHook/blob/main/LICENSE)（SPDX：`GPL-3.0-only`）开源。分发或修改本项目时必须遵守许可证规定，并向接收者提供对应源代码和相同的许可权利。本许可证不涵盖刺猬猫阅读、导出内容或其他第三方作品；相关权利仍归各自权利人所有。
